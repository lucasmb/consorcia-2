$(document).ready(function(){    
    ...
    $("#building_summary").change(function(){
        id_building = $("#building_summary").val();
        if (id_building != ""){
            $("#pay_days").load('index.php/ajax/buildings/pay_actual_days/'+id_building);
    ...
    $("#generate_capitulation_extraordinary").click(function(){
     ...
     $("#building_blank_select").change(function (){
        ...
        if (id != ""){
            $.post('index.php/ajax/reports/get_properties_select', {id:id}, function(rta){
    ...
    $("#building_balance_select").change(function (){
        ...
        if (id != ""){
            $.post('index.php/ajax/reports/get_building_periods', {id:id}, function(rta){
    ...
    $("#building_autogenerated_days_select").change(function(){
        ...
        if (id_building != ""){
            $("#autogenerated_pay_days").load('index.php/ajax/buildings/autogenerated_pay_days/'+id_building);
        }
        else{
