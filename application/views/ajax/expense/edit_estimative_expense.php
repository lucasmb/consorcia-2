...
$(document).ready(function() {
    ...
    $('#submit').click(function(){
        $.post('index.php/ajax/expenses/save_edit_estimative_expense' , $("#frm_edit_estimative_expense").serialize(), function(rta){
...
<div class="contenedor">
    <h2>Editar Egreso</h2>
    <form id="frm_edit_estimative_expense" method="post" >
